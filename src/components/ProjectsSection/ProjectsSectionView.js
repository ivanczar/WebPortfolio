        ...
        <ProjectsWrapper>
          ...
          <CardsContainer>
            <Card
              ...
              title={"SportsHub"}
              text={
                "SportHub was built following the Scrum Development Methodology. Sportshub allows athletes to browse, join or host sporting events in their area. It also contains a public chat feature and the ability to join teams and customize your profile."
              }
              icons={shIcons}
            />
            ...
            <Card
              ...
              title={"BlackJack"}
              text={"An interactive blackjack game built with Java and Swing. Users can login and play against the AI. A scoreboard and all user info is saved in a SQL database via JDBC."}
              icons={bjIcons}
            />
                       <Card
              logo={wplogo}
              ...
              text={"A responsive website portfolio built with React and Styled Components. It features a contact form, a portfolio of projects, and a about me section. It also features smooth scrolling and different themes."}
              icons={wpIcons}
            />
          </CardsContainer>
        </ProjectsWrapper>
